function y = simple_param_decode(flag, D0, D1, FRAG, msg, bits)
...
switch flag
    case 0
        xlswrite('simple_data.xlsx',xlsdata,5,'B2');
    case 1
        xlswrite('simple_data.xlsx',xlsdata,5,'B3');
    case 2
        xlswrite('simple_data.xlsx',xlsdata,5,'B4');
    case 3
        xlswrite('simple_data.xlsx',xlsdata,5,'B5');
end;
